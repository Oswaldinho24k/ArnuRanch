...
import {DELETE_CORRAL_SUCCESS, GET_CORRALES_SUCCESS, SAVE_CORRAL_SUCCESS} from "../../actions/ganado/corralesActions";
...
function list(state=[], action){
    switch(action.type){
        ...
        case DELETE_CORRAL_SUCCESS:
            let acualList = state.filter(a=>{
                return a.id!=action.corralId;
            });
            return acualList;
